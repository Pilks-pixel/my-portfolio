				...
				<main className={utils.main}>
					...
					<section className={`${utils.challenges} ${utils.sections}`}>
						...
						<p>
							...
							site. I also chose to use an the web animation API with an
						...
						<h3>Contact Form</h3>
						<p>
							The useState hook allowed a controlled form with validation for
							user input, including Regex pattern for email inputs. I was able
							to make use of the in built next js API. This allowed me to handle
							form submission of user data with the node mailer library.
						</p>
					</section>
